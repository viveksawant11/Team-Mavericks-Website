        ...
        <div class="pagetitle">
            <div class="row">
                ...
                <div class="col sideButton align-right">
                    <button class="btn btn-warning" type="button" style="margin-right:2vh" onclick = "window.location.href='participants.php';"><i class="bi bi-arrow-90deg-left"></i> Go Back</button>
                            ...
                            foreach ($da['participants'] as $participant) {
                                ...
                                echo "
												<tr>
													...
													<td><a href='images/payment/proof" . $participant['participant_srno'] . $event['event_srno'] . $registration['registration_srno'] . ".png' target='_blank'>Click here</a></td>
													<td>
